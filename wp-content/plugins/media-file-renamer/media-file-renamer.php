		...
		$fields = array(
			'mfrh_basics' => array(
				array(
					...
					'options' => array(
						...
						'desc' => __( '<i>Something is not updated when you rename a file? Please <a href="http://meowapps.com/contact/">contact me</a> and I will add support for it.</i>', 'media-file-renamer' ),
						'type' => 'html',
						'default' => false
				), array(
						'name' => 'rename_slug',
			...
			'mfrh_pro' => array(
				...
				array(
						...
						'desc' => __( '<br />Enter your serial or subscription ID here. If you don\'t have one yet, get one <a target="_blank" href="http://meowapps.com/media-file-renamer/">right here</a>.', 'media-file-renamer' ),
						'type' => 'text',
						'default' => ""
				),
			)
